...
secRouter.post("/create/schemes", upload.single("file"), createResourceHandler);
secRouter.post("/create/kcse/past/papers", upload.single("file"), createResourceHandler);
secRouter.post("/create/kcse/trial/examinations", upload.single("file"), createResourceHandler);
secRouter.post("/create/fullset/examinations", upload.single("file"), createResourceHandler);
secRouter.post("/create/revision/notes", upload.single("file"), createResourceHandler);
secRouter.post("/create/holiday/revision", upload.single("file"), createResourceHandler);
secRouter.post("/create/holiday/assignments",upload.single("file"), createResourceHandler)
